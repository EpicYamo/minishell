SRC		:= minishell.c \
			...
			parser/parser_pt_four.c parser/parser_pt_five.c parser/environment_parser_pt_one.c \
			parser/environment_parser_pt_two.c parser/environment_parser_pt_three.c \
			...
			utils/utils_pt_nine.c utils/utils_pt_ten.c utils/garbage_collector.c utils/banner.c \
			utils/signals.c \
